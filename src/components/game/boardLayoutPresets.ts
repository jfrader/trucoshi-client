...
const PROFILE_LAYOUT_TOKENS: Record<BoardViewportProfile, BoardProfileLayoutTokens> = {
  ...
  phoneWide: {
    ...
    match: {
      ...
      dock: {
        handCardWidth: "clamp(2.48rem, 6.5dvh, 3.26rem)",
  ...
  tabletWide: {
    ...
    match: {
      ...
      dock: {
        handCardWidth: "clamp(3.72rem, 3.95vw, 4.58rem)",
        playedCardWidth: "clamp(3.15rem, 2.75vw, 3.55rem)",
        announcementBlockHeight: "4.75rem",
        handBlockHeight: "6.05rem",
        commandBlockHeight: "3.5rem",
        dockGap: "0.58rem",
        dockBottomOffset: "calc(env(safe-area-inset-bottom) + 3.2rem)",
        bottomDockReserveHeight: "15.75rem",
        handRowMinHeight: "4.95rem",
  ...
  desktop: {
    ...
    match: {
      ...
      dock: {
        handCardWidth: "clamp(3.82rem, 4vw, 4.72rem)",
        playedCardWidth: "clamp(3.2rem, 2.8vw, 3.65rem)",
        announcementBlockHeight: "4.75rem",
        handBlockHeight: "6.2rem",
        commandBlockHeight: "3.5rem",
        dockGap: "0.58rem",
        dockBottomOffset: "calc(env(safe-area-inset-bottom) + 0.28rem)",
        bottomDockReserveHeight: "15.95rem",
        handRowMinHeight: "5.1rem",
        handRowTranslateY: "0.08rem",
        commandCompact: true,
      },
      seatPresentation: {
