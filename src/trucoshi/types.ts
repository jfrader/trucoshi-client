...
import { CardTheme } from "./cardThemes";
...
export interface ITrucoshiActions {
  ...
  setCardTheme: Dispatch<SetStateAction<CardTheme>>;
...
export interface ITrucoshiContext {
  ...
  socket: Socket<CompatibleServerToClientEvents, ClientToServerEvents>;
}

export type CompatibleServerToClientEvents = Omit<
  ServerToClientEvents,
